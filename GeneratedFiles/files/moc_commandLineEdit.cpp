...
QT_MOC_LITERAL(1, 16, 8), // "navigate"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 10), // "QKeyEvent*"
QT_MOC_LITERAL(4, 37, 15), // "keyReleaseEvent"
QT_MOC_LITERAL(5, 53, 1) // "e"

    },
    "commandLineEdit\0navigate\0\0QKeyEvent*\0"
    "keyReleaseEvent\0e"
};
...
void commandLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        commandLineEdit *_t = static_cast<commandLineEdit *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->navigate((*reinterpret_cast< QKeyEvent*(*)>(_a[1]))); break;
        ...
        {
            typedef void (commandLineEdit::*_t)(QKeyEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&commandLineEdit::navigate)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject commandLineEdit::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_commandLineEdit.data,
      qt_meta_data_commandLineEdit,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *commandLineEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_commandLineEdit.stringdata0))
        return static_cast<void*>(const_cast< commandLineEdit*>(this));
...
// SIGNAL 0
void commandLineEdit::navigate(QKeyEvent * _t1)
{
